...
export const ConstructionSiteTileHelp: FC<MaterialHelpProps> = ({ item }) => {
  ...
  return (
    <>
      ...
      <p>
        <Trans i18nKey={`help.construction.site.tile.descr.1`} components={components} />
      </p>
      <p>
        <Trans i18nKey={`help.construction.site.tile.descr.2`} components={components} />
      </p>
      <p>
        <Trans i18nKey={`help.construction.site.tile.descr.3`} components={components} />
      </p>
      <p css={note}>
        <Trans i18nKey={`help.construction.site.tile.note`} components={components} />
      </p>
      <p>
        <Trans i18nKey={`help.construction.site.tile.explain`} components={components} values={{ type }} />
      </p>
      <p>
        <Trans i18nKey={`help.construction.site.tile.resources`} components={components} values={{ type }} />
      </p>
      <ul>
